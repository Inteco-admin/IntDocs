...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Calibration.css":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Calibration.css ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Measure.css":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Measure.css ***!
  \***********************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CalibrationPanel": () => (/* binding */ CalibrationPanel),
/* harmony export */   "CalibrationRequiredDialog": () => (/* binding */ CalibrationRequiredDialog)
/* harmony export */ });
...
var DockingPanel = avu && avu.DockingPanel || /*#__PURE__*/function () {function _class() {_classCallCheck(this, _class);}return _createClass(_class);}();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CalibrationTool": () => (/* binding */ CalibrationTool)
/* harmony export */ });
...
/* harmony import */ var _EventTypes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./EventTypes */ "./extensions/Measure/EventTypes.js");
...
var CalibrationTool = function CalibrationTool(viewer, options, sharedMeasureConfig, snapper)
{
  ...
  this.deactivate = function ()
  {
    ...
    _viewer.dispatchEvent({ type: _EventTypes__WEBPACK_IMPORTED_MODULE_2__.SET_MOUSE_TRACKING, mode: 'end' });
  ...
  this._handleMouseEvent = function (event) {
    ...
    if (_consumeSingleClick) {
      ...
      {
        _viewer.dispatchEvent({ type: _EventTypes__WEBPACK_IMPORTED_MODULE_2__.SET_MOUSE_TRACKING, mode: 'start' });
        this.hidePanel();
        _measurement.indicator.updateLabelValue(null);
        _waitingForInput = false;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CalibrationToolIndicator": () => (/* binding */ CalibrationToolIndicator)
/* harmony export */ });
...
proto.drawMeasurementLineTip = function (point, direction, normal, flip) {
  ...
  var tmpPoints = [new THREE.Vector3(), new THREE.Vector3()];
...
/***/ "./extensions/Measure/EventTypes.js":
/*!******************************************!*\
  !*** ./extensions/Measure/EventTypes.js ***!
  \******************************************/
/***/ ((module) => {
...
proto.drawEdgeAsCylinder = function (geom, material, linewidth, type, cylinderGeometry) {
  ...
  if (type == 1) {// LinePieces
    for (var i = 0; i < position.count; i += 2) {
  ...
  {// LineStrip
    for (var _i = 0; _i < position.count - 1; _i++) {
      v0.fromBufferAttribute(position, _i);
      v1.fromBufferAttribute(position, _i + 1);
      cylinder = this.cylinderMesh(v0, v1, material, linewidth, cylinderGeometry);
      this.setCylinderScale(cylinder, v0, v1);
      edge.push(cylinder);
    }
...
proto.drawLineAsCylinder = function (geom, material, linewidth, overlayName) {
  ...
  var position = geom.getAttribute('position');
  if (position.count == 2) {
    var p0 = new THREE.Vector3().fromBufferAttribute(position, 0);
    var p1 = new THREE.Vector3().fromBufferAttribute(position, 1);
...
proto.renderRubberband = function (picks) {
  ...
  switch (this.measurement.measurementType) {
    ...
    case MeasureCommon.MeasurementTypes.MEASUREMENT_ARC:{
        var _previewsPick = picks[1];
        var _activePick = picks[2];

        if (_previewsPick && _activePick) {
          this.renderArcMeasurement(_previewsPick, _activePick);
        }
        break;
      }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasureTool": () => (/* binding */ MeasureTool)
/* harmony export */ });
...
function MeasureTool(viewer, options, sharedMeasureConfig, snapper)
{
  ...
  function getPickData(measurement) {
    ...
    for (var i = 0; i < picks.length; i++) {
      ...
      var model = Object.prototype.hasOwnProperty.call(pick, 'modelId') && pick.modelId ? _viewer.impl.findModel(pick.modelId) : _viewer.model;
      if (model) {
  ...
  this.isolateMeasurement = function () {
    ...
    for (var key in _measurementsManager.measurementsList) {
      if (Object.prototype.hasOwnProperty.call(_measurementsManager.measurementsList, key)) {
        ...
        var measurement = _measurementsManager.measurementsList[key];
        for (var _key in measurement.picks) {
          if (Object.prototype.hasOwnProperty.call(measurement.picks, _key)) {
            var pick = measurement.getPick(_key);
    ...
    var isolationSet = [];
    for (var _modelId in isolationGroups) {
      if (Object.prototype.hasOwnProperty.call(isolationGroups, _modelId)) {

        var modelInstance = _viewer.impl.findModel(parseInt(_modelId));
        isolationSet.push({
          model: modelInstance,
          ids: isolationGroups[_modelId] });
  ...
  this._doConsumeSingleClick = function () {var _this$getActivePick;
    ...
    _viewer.dispatchEvent({ type: _EventTypes__WEBPACK_IMPORTED_MODULE_2__.SET_MOUSE_TRACKING, mode: measurementComplete ? 'end' : 'start' });

    avp.analytics.track('viewer.measure', {
      action: 'Measurement',
      type: MeasureCommon.MeasurementTypesToAnalytics[_currentMeasurement.measurementType],
      snapping: ((_this$getActivePick = this.getActivePick()) === null || _this$getActivePick === void 0 ? void 0 : _this$getActivePick.geomType) !== MeasureCommon.SnapType.RASTER_PIXEL });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasureToolIndicator": () => (/* binding */ MeasureToolIndicator)
/* harmony export */ });
/* harmony import */ var _Indicator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Indicator */ "./extensions/Measure/Indicator.js");
...
proto.updateLabelsPosition = function () {var _this = this;
  ...
  if (this.arcLabel) {
    ...
    if (label && this.arcLabel.p1 && this.arcLabel.p2 && isVisible(label)) {
      ...
      // Rotate the label
      var _p1Projected = MeasureCommon.project(this.arcLabel.point1Relative, this.viewer);
      var _p2Projected = MeasureCommon.project(this.arcLabel.point2Relative, this.viewer);

      if (label.clientWidth >= _p1Projected.distanceTo(_p2Projected) - this.endpoints[1].label.clientWidth) {
...
proto.drawXYZLine = function (item) {
  ...
  var tmpPoints = [new THREE.Vector3(), new THREE.Vector3()];
  var geometry = item.geometry = new THREE.BufferGeometry();
  ...
  if (keys.length > 2) {
    ...
    if (this.measurement.area !== 0) {
      ...
      if (this.drawSurface(points)) {
        this.showAreaLabel((0,_PolygonCentroid__WEBPACK_IMPORTED_MODULE_1__.getPolygonVisualCenter)(points));
        this.updateArea();
      }
    }
  }
...
proto.drawAngle = function (p, ep1, ep2, n, angle, midPoint, _radius) {
  ...
  var arcGeomPosition = arc.geometry.getAttribute('position');
  {
    var untypedPositions = Array.from(arcGeomPosition.array); // convert from Float32Array to Array to use concat
    var untypedCenter = untypedPositions.slice(0, arcGeomPosition.itemSize); // get the x,y,z of the center
  ...
  var vA = new THREE.Vector3().fromBufferAttribute(arcGeomPosition, 1);
  var vB = new THREE.Vector3().fromBufferAttribute(arcGeomPosition, arcGeomPosition.count - 2);
  ...
  var outlineGeometry = new THREE.CircleBufferGeometry(radius, segments, 0, angle * Math.PI / 180);
  {
    var outlineGeomPosition = outlineGeometry.getAttribute('position');
...
proto.drawCircularArc = function (point1, point2, center, radius) {var drawTips = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
  ...
  {
    var circleGeomPosition = circleGeometry.getAttribute('position');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasureToolbar": () => (/* binding */ MeasureToolbar)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getCentroidOfPolygon": () => (/* binding */ getCentroidOfPolygon),
/* harmony export */   "getPolygonVisualCenter": () => (/* binding */ getPolygonVisualCenter)
/* harmony export */ });
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Calibration_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!../../node_modules/sass-loader/dist/cjs.js!./Calibration.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Calibration.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Calibration_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Calibration_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Calibration_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Calibration_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Measure_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!../../node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!../../node_modules/sass-loader/dist/cjs.js!./Measure.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[5].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[5].use[2]!./node_modules/sass-loader/dist/cjs.js!./extensions/Measure/Measure.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Measure_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Measure_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Measure_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_ruleSet_1_rules_5_use_1_node_modules_postcss_loader_dist_cjs_js_ruleSet_1_rules_5_use_2_node_modules_sass_loader_dist_cjs_js_Measure_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MeasureExtension": () => (/* binding */ MeasureExtension)
/* harmony export */ });
...
MeasureExtension.prototype.load = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {var _this = this;var self, viewer, measureToolOptions, onToolChangedCb;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
          ...
          this.viewer.prefs.addListeners(avp.Prefs.DISPLAY_UNITS_PRECISION, this._onPrecisionPrefChanged, this._onPrecisionPrefChanged);return _context.abrupt("return",

          true);case 36:case "end":return _context.stop();}}}, _callee, this);}));
...
MeasureExtension.prototype._onDisplayUnitsPrefChanged = function (value) {
  if (value !== '') {var _this$measureToolbar;
    this.setUnits(value);
    (_this$measureToolbar = this.measureToolbar) === null || _this$measureToolbar === void 0 ? void 0 : _this$measureToolbar.updateSettingsPanel();
...
MeasureExtension.prototype._onPrecisionPrefChanged = function (value) {
  if (typeof value === 'number') {var _this$measureToolbar2;
    this.setPrecision(value);
    (_this$measureToolbar2 = this.measureToolbar) === null || _this$measureToolbar2 === void 0 ? void 0 : _this$measureToolbar2.updateSettingsPanel();
  }
};
...
MeasureExtension.prototype._onModelLoaded = function (event) {
  ...
  if (!this.sharedMeasureConfig.units) {var _this$measureToolbar3;
    (_this$measureToolbar3 = this.measureToolbar) === null || _this$measureToolbar3 === void 0 ? void 0 : _this$measureToolbar3.disableUnitOption();
  }
...
Autodesk.Extensions.Measure = __webpack_exports__;
/******/ })()
;
